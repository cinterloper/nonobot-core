...
public class BotAdapter {
   ...
   *
   * When the handler is connected, it should call {@link io.vertx.core.Future} to signal the adapter it is
   * connected, if the connection attempt fails, it should instead call {@link io.vertx.core.Future}.<p>
   *
