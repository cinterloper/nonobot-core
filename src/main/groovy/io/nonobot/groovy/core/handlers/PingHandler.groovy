...
public class PingHandler {
  private final def io.nonobot.core.handlers.PingHandler delegate;
  public PingHandler(Object delegate) {
    this.delegate = (io.nonobot.core.handlers.PingHandler) delegate;
  }
  public Object getDelegate() {
    return delegate;
  }
  public static PingHandler create() {
    def ret= InternalHelper.safeCreate(io.nonobot.core.handlers.PingHandler.create(), io.nonobot.groovy.core.handlers.PingHandler.class);
    return ret;
  }
